...
@section('content')
  <div class="col-md-8">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <p class="alert alert-info"><i class="fa fa-info-circle"></i> Fitur materi masih dalam tahap pengembangan. Fitur ini sedang kami bangun integrasi dengan portal <a href="https://ayosinau.com" target="_blank">Ayosinau.com</a>. Untuk itu, selalu pantau update CBT SMEPRI di akun Github CBT SMEPRI ya <i class="fa fa-smile-o" aria-hidden="true"></i>.</p>
      </div>
    </div>
  </div>
  <div class="col-md-4">
