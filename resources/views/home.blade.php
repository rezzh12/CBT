...
@extends('layouts.app')
@section('title', 'CBT SMEPRI - Aplikasi Ujian Berbasis Komputer')
@section('breadcrumb')
  <h1>Dashboard</h1>
  <ol class="breadcrumb">
...
@section('content')
  ...
  @else
    <div class="alert" style="background: #fff; border: solid thin #d8d5d5;">
      <p>Hai {{ Auth::user()->nama }}, Selamat datang di CBTSMEPRI. Disini kamu bisa temukan materi yang telah disiapkan oleh Guru serta mengerjakan soal latihan dan ujian.</p>
...
<script src="{{url('assets/plugins/datatables/extensions/FixedHeader/js/dataTables.fixedHeader.js')}}"></script>
  ...
  $(document).ready(function (){
    table_soal = $('#table_soal').DataTable({
      ...
      responsive: true,
      lengthChange: true,
      ajax: '{{ route("elearning.get-soal-home") }}',
        columns: [
