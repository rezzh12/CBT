...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-mini"><b>CBT</b>SMEPRI</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>CBT</b>SMEPRI</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        !-->
        <li class="{{ Request::is('distribusi*') == true ? 'active' : '' }}"><a href="{{ url('/distribusi') }}"><i class="fa fa-american-sign-language-interpreting"></i> <span>Distribusikan</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2025-{{ date('Y') }} <a href="#" >ezxsutxza</a>.</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
